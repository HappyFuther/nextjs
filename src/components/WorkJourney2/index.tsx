...
const WorkJourney2: React.FC = () => {
  ...
  const linearGrad = "linear-gradient(to right,rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url('/Images/bg.jpg')";
    ...
    <div className="relative h-fit-content group font-dmsans mt-5">
      {data.length > 3 && indexValue > 0 && (
        <button
          ...
          style={{ border: 'none' }}
        >
          <svg className='m-2' xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024"><path fill="#031318" d="M685.248 104.704a64 64 0 0 1 0 90.496L368.448 512l316.8 316.8a64 64 0 0 1-90.496 90.496L232.704 557.248a64 64 0 0 1 0-90.496l362.048-362.048a64 64 0 0 1 90.496 0z"/></svg>
        </button>
      )}
      ...
      {data.length > 3 && indexValue < data.length - 1 && (
        <button
          ...
          style={{ border: 'none' }}
        >
        <svg className='m-2' xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024"><path fill="#031318" d="M338.752 104.704a64 64 0 0 0 0 90.496l316.8 316.8l-316.8 316.8a64 64 0 0 0 90.496 90.496l362.048-362.048a64 64 0 0 0 0-90.496L429.248 104.704a64 64 0 0 0-90.496 0z"/></svg>
        </button>
      )}
                ...
                >
                  <div
                    ...
                    className={`card hidden sm:block p-6 py-[50px] px-[30px]
                     shadow  mx-2 transform transition-all duration-300 cursor-pointer ${isSelected ? 'scale-95 text-7xl' : 'scale-95'} ${isSelected ? '' : 'shadow-grey '} ${isSelected ? "" : "bg-white"}`}               
                    style={{
                      width: 'inherit',
                      height: 'inherit',
                  ...
                  >
                    <div
                      className={` flex flex-col justify-between  ${isSelected ? 'text-2xl' : 'text-xl'} flex  h-full `}
                    >
                     ...
                     <div 
                      ...
                      >
                        ...
                        <div
                         className='text-4xl min-h-[150px] max-h-[150px]  flex items-center overflow-hidden  my-5 font-bold leading-snug truncate-multiline'
                        >
                          {item.type} 
                        ...
                        <div
                         className={`${ isSelected ? 'bg-white' : 'bg-black' } w-full h-2 rounded-full`}
                        ></div>
                      ...
                      <div
                       className={`${ isSelected ? 'text-white' : 'text-black' } text-[#8c8c8c] text-[18px]`}>
                        {item.date}
                  ...
                  <div
                    ref={cardRefs.current[index]}
                    className={`card block sm:hidden py-[25px] px-[15px] shadow rounded-lg mx-2 transform transition-all duration-300 cursor-pointer ${ isSelected ? 'scale-95 text-7xl' : 'scale-95'} ${isSelected ? '' : 'shadow-grey'} ${isSelected ? "" : "bg-white"}`}
                    style={{
                      width: '100px',
                      height: '100px',
                      background: 'black',
