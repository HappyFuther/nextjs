...
const SocialMediaScroll: React.FC = () => {
  ...
  const iconDisplay = (item: any, isSelected: any, itemLink: any) => {
    if (item === 'Email') {
      return (
        <a href={`mailto:${itemLink}`} target="_blank" rel="noreferrer">
          <svg
      ...
      return (
        <a href={`tel:${itemLink}`} target="_blank" rel="noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
          ...
          <div className="flex justify-center">
            {data
              ...
              ?.map((item: Contact, index: number) => {
                ...
                return (
                  <div
                    className="flex flex-col items-center justify-center h-[90px]"
